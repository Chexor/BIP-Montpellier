# BIP Montpellier Hackathon Workspace

This workspace is prepared for fast hackathon work in Montpellier.
...
1. Add the official challenge brief to `docs/brief.md`.
2. Capture team roles and communication links in `docs/notes.md`.
3. Pick a tech stack only after the demo target is clear.
4. Keep `docs/tasks.md` updated with the next concrete action.
5. Move final deliverables into `submission/` as they become stable.

## Working Rule

Favor a small, working demo over a broad unfinished concept. Record assumptions in `docs/decisions.md` whenever the brief or data is incomplete.
